...
for p = 1
%%
filename_data ='/home/lasso/Desktop/md0/data/sweep_feq/1219_jcq/star_1.bin';
...
%% 
data_count = 2184*1;
S_ref = chan_seq_cali(1,1:data_count);
S_tar = chan_seq_cali(2,1:data_count);
...
figure
idxNum = 1e5;
for idx = 1:chan_num_total
    % subplot(chan_num_total,1,idx)
    pwelch(chan_seq_cali(idx,1:idxNum),[],[],[],f_s,'center');hold on;
end
